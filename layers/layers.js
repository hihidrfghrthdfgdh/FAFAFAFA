...
lyr_CONG_14.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'SHAPE_Length': 'SHAPE_Length', 'D': 'D', 'DOC_I': 'DOC_I', 'Q_MUA': 'Q_MUA', 'Q_CONG': 'Q_CONG', 'V': 'V', 'H_D': 'H_D', 'H_D_20': 'H_D_20', 'NGAY_LAP_DAT': 'NGAY_LAP_DAT', 'NGAY_BAO_TRI': 'NGAY_BAO_TRI', 'GHI_CHU': 'GHI_CHU', });
...
lyr_CONG_14.set('fieldImages', {'OBJECTID': 'TextEdit', 'SHAPE_Length': 'TextEdit', 'D': 'TextEdit', 'DOC_I': 'TextEdit', 'Q_MUA': 'TextEdit', 'Q_CONG': 'TextEdit', 'V': 'TextEdit', 'H_D': 'Range', 'H_D_20': 'TextEdit', 'NGAY_LAP_DAT': 'DateTime', 'NGAY_BAO_TRI': 'DateTime', 'GHI_CHU': 'TextEdit', });
...
lyr_CONG_14.set('fieldLabels', {'OBJECTID': 'header label - visible with data', 'SHAPE_Length': 'header label - always visible', 'D': 'header label - visible with data', 'DOC_I': 'header label - visible with data', 'Q_MUA': 'header label - always visible', 'Q_CONG': 'header label - always visible', 'V': 'header label - always visible', 'H_D': 'header label - always visible', 'H_D_20': 'header label - always visible', 'NGAY_LAP_DAT': 'header label - always visible', 'NGAY_BAO_TRI': 'header label - always visible', 'GHI_CHU': 'header label - always visible', });
